...
"""
Macro-Only GA Wrapper (Normalized Output Interface)

This module exposes a standardized interface for executing the Macro-only
variant of the Macro→Micro Genetic Algorithm across heterogeneous environments.
It force-sets crossover to macro (p_micro=0.0, p_macro=1.0), normalizes outputs
...
def run_macro_w2(
    ...
    t0 = time.time()
    res = run_macro_w1(graph, prices, agents, hp_merged)
