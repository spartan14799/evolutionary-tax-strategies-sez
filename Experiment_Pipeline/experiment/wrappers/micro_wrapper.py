...
def run_micro_w1(
    ...
    """
    Run a single-environment **Micro-only GA** (p_macro = 0) with genome length
    ...
    # --- Run Macro→Micro GA (Micro-only mode) ---
    ...
    # Fix: identify correctly as “micro”
    return {"name": "micro", **res}
