...
from Experiment_Pipeline.fine_tuning.flat_wrapper import run_flat_w2
...
base_hyperparams = {"generations": 12,
        "popsize": 15,'fix_last_gene': True,'seed': 42,'parent':14}

candidate_hp = {'mutation_rate': 0.05,'parent':0.35}


test = run_flat_w2(test_env, base_hyperparams, candidate_hp)
